...
n = 100
print(f"Число: {n}")
print(f"Простые множители: {prime_factors(n)}")
print(f"Количество делителей: {number_of_divisors(n)}")
print(f"Сумма делителей: {sum_of_divisors(n)}")
print(f"Функция Эйлера: {euler_phi(n)}")